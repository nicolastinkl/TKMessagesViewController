...
{
    CGFloat maxWidth = [UIScreen mainScreen].applicationFrame.size.width * 0.70f;
    //NSLog(@"%lu   ,empty : %lu",(unsigned long)[JSMessageTextView numberOfLinesForMessage:txt],[txt js_emptyNumberOfLines]);
    
    CGFloat maxHeight = [self heightForCellWithPost:txt];
    
//    CGFloat maxHeight = MAX([JSMessageTextView numberOfLinesForMessage:txt],[txt js_numberOfLines]) * [JSMessageInputView textViewLineHeight];
    ...
    if ( NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_6_0) {
        ...
        stringSize = [txt sizeWithFont:[[JSBubbleView appearance] font] constrainedToSize:CGSizeMake(maxWidth, maxHeight)];
    }
