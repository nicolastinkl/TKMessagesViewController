...
- (void)adjustTextViewHeightBy:(CGFloat)changeInHeight
{
    ...
    self.textView.contentInset = UIEdgeInsetsMake((numLines >= 3 ? maxlines : 0.0f),
                                                  0.0f,
                                                  (numLines >= 3 ? maxlines : 0.0f),
                                                  0.0f);
...
+ (CGFloat)maxLines
{
    return maxlines;// ([UIDevice currentDevice].userInterfaceIdiom == UIUserInterfaceIdiomPhone) ? 4.0f : 8.0f;
}
